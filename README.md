...
1.Git
Descrpiton: Git is the software for version control, or version control software. You can run it anywhwere, on any device, such as your laptop.

2. Github
Description: A webservice that people can collaborate on. They can sign up, have an account, and do anything on it, including stuff that involve Git, while on the github server. Overall, github is a social network for projects that are managed by git or have git on them.
